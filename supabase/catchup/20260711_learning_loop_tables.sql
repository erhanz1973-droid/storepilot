-- StorePilot catch-up: Outcome Learning + Decision Feedback tables
-- Run once in Supabase Dashboard → SQL Editor if you see:
--   recommendation_lifecycle_events ... schema cache
--   decision_rejection_feedback table missing
--
-- Safe to re-run (IF NOT EXISTS / ADD COLUMN IF NOT EXISTS).

-- ── From 20260631120000_recommendation_intelligence.sql ──
...
-- ── From 20260702120000_decision_engine.sql ──
...
-- Refresh PostgREST schema cache (Supabase picks this up within ~1 min)
