...
export const DEMO_SCENARIOS: Record<DemoScenarioId, DemoScenarioDefinition> = {
  healthy_growth: {
    ...
    description: "Profitable store with room to scale — AI focuses on optimization and expansion.",
    personality: "growth",
    focusVerbs: ["Scale", "Expand", "Increase budget", "Grow revenue", "Increase customer lifetime value"],
    storeDisplayName: "Summit Supply Co.",
    revenue30d: 82_400,
    orders30d: 660,
    aov: 124.85,
    conversionRatePct: 3.1,
    metaSpend7d: 4_200,
    metaRevenue7d: 16_800,
    googleSpend7d: 2_100,
    googleRevenue7d: 8_400,
    sessions30d: 21_300,
    storeHealthScore: 91,
